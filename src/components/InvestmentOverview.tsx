...
import { TrendingUp, TrendingDown, DollarSign, Calendar, Layers } from "lucide-react";
  ...
  return (
    <Card className="p-6 border-border bg-card">
      ...
      <div className="space-y-3 text-sm">
        ...
        <Row label="Net Multiple on Outlay" value={formatMultiple(gain.netMultipleOnOutlay)} highlight={isPositive} negative={!isPositive} bold />
      </div>
    </Card>
  );
}
